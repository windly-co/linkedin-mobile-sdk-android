...
public class LISessionManager {
  ...
  private static final String LI_APP_AUTH_CLASS_NAME =
  ...
  private static final String LI_ERROR_DESCRIPTION =
      "com.linkedin.thirdparty.authorize.RESULT_ACTION_ERROR_DESCRIPTION";
   ...
   * {@link com.linkedin.platform.LISessionManager#init(android.app.Activity, com.linkedin.platform.utils.Scope,
   * com.linkedin.platform.listeners.AuthListener, boolean)}
   */
