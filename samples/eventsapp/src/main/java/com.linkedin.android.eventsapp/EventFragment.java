...
public class EventFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
              ...
              .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                  ...
                  try {
                    ...
                    shareObject.put("comment",
                        "I am attending " + eventNameArg + " in " + eventLocationArg + " on " + dateString);
                  } catch (JSONException e) {

                  }
                  APIHelper.getInstance(getActivity())
                      .postRequest(getActivity(), Constants.shareBaseUrl, shareObject, new ApiListener() {
                        @Override
                        ...
                        public void onApiError(LIApiError apiError) {
                          ...
                          Toast.makeText(getActivity(), "Your share was unsuccessful. Try again later!",
                              Toast.LENGTH_LONG);
                        }
                      });
                }
    ...
    AttendeeAdapter adapter =
        new AttendeeAdapter(getActivity(), R.layout.attendee_list_item, attendeesArg, accessTokenValid);
